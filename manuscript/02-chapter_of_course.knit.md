...
{alt: 'an image', width=80%}![](resources/images/02-chapter_of_course/unnamed-chunk-3-1.png)<!-- -->
...
{alt: 'an image', width=80%}![](resources/images/itcr_training_network.png)

{alt: 'an image', width=80%}![](resources/images/tools.png)
