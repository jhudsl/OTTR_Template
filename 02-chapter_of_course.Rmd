...
See [here](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf) for additional general information about how you can format text within RMarkdown files. In addition, see [here](https://pandoc.org/MANUAL.html#pandocs-markdown)for more in depth and advanced options.
...
You can use these boxes in your course with either of two options: using html code or ookdown/latc
...
#### Using Pandoc div box sytax

Pandoc allows for a different sytnax to be converted to the html that you just saw and also allows for conversion to LaTeX. See the [bookdown](https://bookdown.org/yihui/rmarkdown-cookbook/custom-blocks.html) documentation for more information [@Xie2020].
